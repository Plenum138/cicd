...
const stripe = require('stripe')("sk_test_51Iug0ySBeksr324AEdRUyHkaUCBltZGhwgfH4QEL6QvbPvptZA9Lz10RFV7SWSSDWRSg7G3Gb5o17WTRCzYeqD8k0053HV1WZL")
...
console.log('data', userData)
    ...
    accountDeactivated: async (req, res, next) => {
        ...
        try {
            ...
            await UserLogins.updateOne({ _id: user._id }, { $set: { payment_status: true, user_status: true } });

            // const payment = await stripe.paymentIntents.create({
            //     amount: 20 * 100,
            //     currency: "INR", 
            //     description: "Test Vivaquad Payment",
            ...
            return res.status(200).send({ status: true, message: "Payment Successfull Please Login." });
        } catch (e) {
