...
router.post('/api/user/changePassword', authCtrl.changepassword)
...
router.post('/api/user/get-profile', authCtrl.getUserProfile);
...
//EMPLOYEE API
router.post('/api/employee/swipe-meal', authCtrl.swipeMeal)
router.post('/api/user/meal-list', authCtrl.userMealList)
